...
<form action="addTeacherCourseServlet" method="post">
    <table class="table2">
        <tr>
            <td><label for="name">请输入课名:</label><input id="name" type="text" name="name" ></td>
        </tr>
        <tr>
            <td><label for="classroom">请输入教室号:</label><input id="classroom" type="text" name="classroom"></td>
        </tr>
        <tr>
            <td><label for="maxNumber">请输入上课人数:</label><input id="maxNumber" type="text" name="maxNumber" value="50"></td>
        </tr>
        <tr>
            <td><label for="major">请输入专业:</label><input id="major" type="text" name="major" value="${sessionScope.number.major}"></td>
        </tr>
        <tr>
            <td><label for="course">请输入选/必修:</label><input id="course" type="text" name="course" value="必修"></td>
        </tr>
        <tr>
            <td><label>
                请输入上课时间:
