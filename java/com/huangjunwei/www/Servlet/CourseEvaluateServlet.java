 ...
 * @author HJW
 */
@WebServlet("/courseEvaluateServlet")
public class CourseEvaluateServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        /*按顺序把学生课表评价存进集合，并转发给页面*/
        request.setAttribute("studentCourses",studentCourseDao.findStudentCourse(user.getId()));
        ...
        request.setAttribute("add_success",request.getParameter("add_success"));

        request.getRequestDispatcher("CourseEvaluate.jsp").forward(request,response);
    }
}
