...
public class CourseDao {
    ...
    /**
     * 通过courseId确定课程修改课程信息
     */
    public void updateTeacherCourse(int courseId,String name,String major,String course,int maxNumber,int classroom,String beginTime,String endTime){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ...
        try {
            conn = JdbcUtils.getConnection();
            String sql = "update t_course set name=? ,major=? ,course=? ,classroom =? max_Number =? ,begin_time=? ,end_time=? where id=? ";
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1,name);
            pstmt.setString(2,major);
            pstmt.setString(3,course);
            pstmt.setInt(4,classroom);
            pstmt.setInt(5,maxNumber);
     ...
     * 直接在t_course上添加课程
     */
    public void addCourse(int teacherId,String major,int classroom,String course,String beginTime,String endTime,int maxNumber,int grade,String name){
        Connection conn = null;
        PreparedStatement pstmt = null;
        ...
        try {
            conn = JdbcUtils.getConnection();
            String sql = "insert into t_course (user_id,name,classroom,max_number,course,major,grade,begin_time,end_time) value (?,?,?,?,?,?,?,?,?)";
            pstmt = conn.prepareStatement(sql);
            pstmt.setInt(1,teacherId);
