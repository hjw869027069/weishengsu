...
<table class="table1">
    ...
    <tr>
        <td colspan="4">
            <label for="search"></label><input type="text" placeholder="请输入课名查找" id="search"><input type="submit" name="courseName" value="搜索">
        </td>
    </tr>
</table>
...
<span class="success"><strong>${requestScope.add_success}</strong></span>
<span class="success"><strong>${requestScope.search_error}</strong></span>
</body>
</html>
